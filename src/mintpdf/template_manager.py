...
class TemplateManager:
    ...
    BUILTIN_TEMPLATES = [
        ...
        Template(
            "Executive",
            "Formal corporate report layout with prominent titles",
            "Business",
            margins={"top": 72.0, "bottom": 72.0, "left": 72.0, "right": 72.0},
        ),
        Template(
            "Technical Report",
            "Structured layout with technical sections and code blocks",
            "Technical",
        ...
        Template(
            "Thesis",
            "Academic style for university thesis and dissertations",
            "Academic",
            margins={"top": 72.0, "bottom": 72.0, "left": 90.0, "right": 54.0},
        ),  # wider left margin for binding
        Template(
            "Novel",
            "Compact text layout suited for books and storytelling",
            "Creative",
        ...
        Template(
            "Resume",
            "Sleek column layout for personal CVs",
            "Personal",
            margins={"top": 36.0, "bottom": 36.0, "left": 36.0, "right": 36.0},
            typography={"body_font_size": 9.5, "body_leading": 13.0},
        ),
        Template(
            "Business Proposal", "Modern layout targeted for selling services or ideas", "Business"
        ),
        Template(
            "Newsletter",
            "Multi-column informal layout for updates",
            "Publication",
        ...
        Template(
            "Legal Contract",
            "Numbered clauses with formal borders",
            "Legal",
            margins={"top": 72.0, "bottom": 72.0, "left": 72.0, "right": 72.0},
        ),
        ...
        Template(
            "Standard Draft",
            "Minimal formatting draft style for reviews",
            "General",
    ...
    def get_all_templates(cls) -> List[Template]:
        ...
        # Load customs
        for t in cls.CUSTOM_TEMPLATES.values():
            all_resolved.append(cls.resolve_inheritance(t))
