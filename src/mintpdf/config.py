...
def load_config(console: Optional[Console] = None) -> Optional[AppSettings]:
    ...
    try:
        ...
        if loaded_version < current_version:
            ...
            if console:
                console.print(f"[green]✓ Configuration migrated to schema version {current_version}.[/green]")
...
def run_setup_wizard(console: Optional[Console] = None) -> AppSettings:
    ...
    try:
        ...
        console.print(f"[bold red]Error: Could not create folder {output_path} due to: {e}[/bold red]")
