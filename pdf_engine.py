...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, total_pages: int) -> None:
        ...
        # Colors
        c_primary = HexColor(self.theme.primary)
...
def generate_pdf(
    ...
    try:
        ...
        font_family = FontManager.get_safe_font_name(settings.default_font)
        ...
        for flowable in body_flowables:
            if isinstance(flowable, Paragraph) and flowable.style.name in ['MintH1', 'MintH2', 'MintH3']:
                level = 0
