...
"""
    ...
    assert paragraphs[1].style.leftIndent == 30 # Level 2 (2 spaces // 2 -> level 1 -> 15 + 15 = 30)
    assert paragraphs[2].style.leftIndent == 45 # Level 3 (4 spaces // 2 -> level 2 -> 15 + 30 = 45)
